...
import { BrainCircuit, User, Mail, Lock, Loader2 } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      toast({ title: "Authenticated", description: "Successfully joined via Google." });
      router.push('/dashboard');
    } catch (error: any) {
        ...
        <Card className="glass-dark border-white/10 shadow-2xl rounded-[3rem] overflow-hidden">
          ...
          <CardContent className="pt-10 space-y-8">
            ...
            <form onSubmit={handleRegister} className="space-y-6">
              ...
              <div className="space-y-3">
                <Label htmlFor="password" title="Password must be at least 6 characters" className="font-black text-xs uppercase tracking-widest text-slate-500">Secure Password</Label>
                <div className="relative">
